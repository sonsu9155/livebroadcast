...
<body class="pr">
    <div class="header" id="J_header">
		<div class="row nav" style=" margin-left: 20%;"> 
			<!-- <a href="/" class="logo fl"></a>  -->
			<div class="col-sm-6 container-fluid bg-light " style="margin-top: 16px">
			...
			<div class="col-sm-6 fr clearfix pr"> 
				<!-- <div class="search fl">
	...
	<div class="row">
		<div class="col-sm-2"> 
			<div style="    text-align: center;    margin-top: 20px;">
				{{ AdvMng::getHTML('shoes') }} 
			</div>
		</div>
		<div class="col-sm-8 xu_main" id="xu_main">
			<div class="row xu_mainfr">
				<div class="col-sm-9 xu_main_left main_width1 fl">
					<div class="row xu_video_wall">
						<ul>
							@if($publishers)
				...
				<div class="col-sm-3 xu_main_right fr">
					<div class="hottest">
					...
					<ul class="hottest_list" id="J_arrive_rank_10">  
						@if($hot_publishers)
