...
<body class="room ">    
   <div class="left_bar" id="J_left_bar" style="display: block;"><div class="logo"><a href="#"></a></div>
   ...
   <div class="live_box" id="J_live_box" style="  opacity: 1;  width: 1480px;    height: 800px;    margin-top: -428px;    margin-left: -747px;">
            ...
            <div class="anchorinfo clearfix pr" id="J_anchorinfo">
                <div class="avatar J_u_card" data-memberid="215380273">
                    <a href="/main/member/personel/user_info5d3b.html?memberid=215380273&amp;jumpbrowser=1" target="_blank" weibo_openid="6395135882">
                        <img src="/upload/{{ $channel->publisher->first()->avartar1 }}" alt="{{ $channel->publisher->first()->name }}">
                    </a>
        ...
        <div class="w400" id="J_w400" style="overflow: hidden;left: 330px;">
            <div class="content flash" id="J_flash" style="margin-left: 0px;" width="100%">
                <iframe src="//iframe.dacast.com/{{ $channel->address}}" width="800" height="500" style="margin-top: 120px"frameborder="0" scrolling="no" allow="autoplay" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
            </div>            
