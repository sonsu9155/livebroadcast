        ...
        <div class="register" style="background-color: rgba(234, 234, 234, 0.8);">
            ...
            <div class="left">
                <div class="tab_wp" >
                    ...
                    <h3 class="tab tab_reg  J_layerreg" style="width:80px"><a href="/auth/register">注册 </a></h3>                
                </div> 
                <form id="J_register" data-title="注册" method="post" action="/auth/doregister">
       ...
       if(password==""){
          ...
          $.post('/auth/dologin',
            ...
            function(res){
                ...
                data = JSON.parse(res);
                alert(data.content);
                window.location.href="/channel?id=1"; 
            });
        });
    </script>
</body>
