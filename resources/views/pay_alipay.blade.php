    ...
    <div class="change_pay_content">
        <div class="pay01_contengt">
            <div class="pay01_contengt_tit fl">
                <img src="/images/pay_06.png" class="pay_06">
                <div class="pay01_contengt_text">支付宝扫码支付</div>
                <div class="pay01_contengt_info">
                    <img src="https://mobilecodec.alipay.com/show.htm?code=gdxox0xodgbhoxtkd7&picSize=S" class="pay_01">
                </div>
            </div>
            <div class="pay01_contengt_big">
                <div class="pay_border">
                    <img src="https://mobilecodec.alipay.com/show.htm?code=gdxox0xodgbhoxtkd7&picSize=S">
                </div>
            </div>
        </div>
        <div class="pay02_contengt" style="display:none">
            <div class="pay01_contengt_tit fl">
                <img src="/images/pay_icon02.png" class="pay_06">
        ...
        <div class="pay03_contengt" style="display: none">
            ...
            <div class="click_more cf">
                <div class="click_more_c">
                    <div>更多</div>
                    <img src="/images/down_icon.png" class="down_icon">
                </div>
            </div>
...
<script>
    ...
    sessionStorage.setItem("checkstand_ali_qrcode", "gdxox0xodgbhoxtkd7");
</script>
</body>
</html>